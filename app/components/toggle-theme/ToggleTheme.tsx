...
const ToggleTheme = () => {
  ...
  return (
    <div className="absolute right-0 mt-5 me-5">
      <div className="relative items-center justify-center flex">
        ...
        <label role="button" htmlFor="toggle-switch" className="hidden peer-checked:block absolute top-0 right-[0.001rem]">
          <MoonIcon className="h-6 w-6 text-black" />
        </label>
        <label role="button"  htmlFor="toggle-switch" className="block peer-checked:hidden absolute top-0 left-[-0.156rem]" >
